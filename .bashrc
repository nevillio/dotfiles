...
command -v bluetoothctl &> /dev/null && alias connect_bluetooth="bluetoothctl connect $(get_bluetooth_config 'NIRVANA_ION')"

# pnpm
export PNPM_HOME="/home/nevillio/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
